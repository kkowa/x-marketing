...
//         // If scroll animation is still visible, hide it first and start the 1s delay for button
...
//           // Wait 1 second before showing the button
...
//               setShowButton(true);
//             }
//           }, 1000); // Changed to 1s delay instead of 2s
