...
//   nextSection:
//     "relative h-screen w-full flex items-center justify-center bg-[#020103] text-white text-3xl font-bold mt-[600px] z-20",
//   textContainer:
...
//       const buttonThreshold = windowHeight * 0.8; // Increased from 0.4
